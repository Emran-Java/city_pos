 ...
 */
public class RecordPrintReceiptDetailFragment extends BaseFragment {
    private FragmentCallback<Void> mCallback;
    private Record mRecord;
    private String buttonText;

    @NonNull
    public static RecordPrintReceiptDetailFragment newInstance(String buttonText, Record record, FragmentCallback<Void> callback) {
        RecordPrintReceiptDetailFragment fragment = new RecordPrintReceiptDetailFragment();
    ...
    @NonNull
    public static RecordPrintReceiptDetailFragment newInstance(Record record, FragmentCallback<Void> callback) {
        RecordPrintReceiptDetailFragment fragment = new RecordPrintReceiptDetailFragment();
        fragment.mCallback = callback;
        fragment.mRecord = record;
        return fragment;
