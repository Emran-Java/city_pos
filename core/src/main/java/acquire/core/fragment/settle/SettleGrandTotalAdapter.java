...
import acquire.core.trans.impl.print_detail.report.SchemeGroupInnerTranTypeAdapter;


public class SettleGrandTotalAdapter extends RecyclerView.Adapter<SettleGrandTotalAdapter.SchemeViewHolder> {

    private List<SchemeGroup> schemeGroups;

    public SettleGrandTotalAdapter(List<SchemeGroup> schemeGroups) {
    ...
    public SchemeViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_settle_grand_total_report, parent, false);
...
//        return String.format("%.2f", amount/100.0);
    ...
    static class SchemeViewHolder extends RecyclerView.ViewHolder {
        ...
        public SchemeViewHolder(@NonNull View itemView) {
            ...
            tvTotalAmount = itemView.findViewById(R.id.tvGrandTotalAmnt);
