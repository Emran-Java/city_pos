...
/**
 * The step that packs {@link InstallmentLogOn} 8583 and sends them to the server.
 *
 * @author Janson
 * @date 2026/5/01 9:20
 */
class InstallmentLogOnStep extends BaseStep {
    ...
    public void intercept(Callback callback) {
        ...
        LoggerUtils.d("LogOn: (PayFlex) Start LogOn");
       ...
       /* pubBean.setMessageId("0200");
        ...
        try {
            ...
            LoggerUtils.d("LogOn: (PayFlex) Before call LogOn ");
            //Call for response
            ...
            if (result != CallerResult.OK) {
                ...
                LoggerUtils.e("LogOn: (PayFlex) call failed");
               // return;
            }

            LoggerUtils.d("LogOn: (PayFlex) call Success");
...
//            Log.d("LogOn:","LogOn: tpkKey:" + tpkKey);
           ...
           /* String tpk = "";
            ...
            LoggerUtils.e("LogOn: (PayFlex) make data for Acknowledgement LogOn call");

            LoggerUtils.d("LogOn: (PayFlex) Change message ID(MTI) 0800 to 0820");
            ...
            LoggerUtils.d("LogOn: (PayFlex) merchant.getMasterKeyIndex(): "+masterKeyIndex);
            LoggerUtils.d("LogOn: (PayFlex) algoType: "+algoType);
...
//                boolean pinResult = pinpadHelper.loadMkskWorkKey(WorkKeyType.PIN_KEY,tpkKey,BytesUtils.hexToBytes(tpkKey), BytesUtils.hexToBytes(tpkKeyKcv));
                boolean pinResult = pinpadHelper.loadBracMkskWorkKey(2, BytesUtils.hexToBytes(tpkKey));

                if (!pinResult) {
                    ToastUtils.showToast(R.string.core_login_load_pin_key_failed);
                    LoggerUtils.e("LogOn: (PayFlex): "+R.string.core_login_load_pin_key_failed);
            ...
            LoggerUtils.d("LogOn: (PayFlex) Success- masterKeyIndex: "+masterKeyIndex+", tpkKey: "+tpkKey);
            LoggerUtils.d("LogOn: (PayFlex) Start second part request");
...
//            Log.d("LogOn:","LogOn: ProcessCode (Field03) 920000 to 920000");
            ...
            if (result2 != CallerResult.OK) {
                //failed
                //ToastUtils.showToast(pubBean.getMessage());
                LoggerUtils.e("LogOn: (PayFlex) second part LogOn call failed");
            ...
            LoggerUtils.e("LogOn: (PayFlex) second part set 8583 field error!",e);
