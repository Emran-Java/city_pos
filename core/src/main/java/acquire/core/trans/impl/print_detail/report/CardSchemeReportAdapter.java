...
public class CardSchemeReportAdapter extends RecyclerView.Adapter<CardSchemeReportAdapter.Holder>{

    private List<CardSchemeReportModel> list;

    public CardSchemeReportAdapter(List<CardSchemeReportModel> list){
        this.list = list;
    }
