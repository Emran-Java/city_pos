...
public class JsonCaller extends BaseCaller {
     ...
     */
    public <T> T execute(String url,Object requestObject, Class<T> responseClass, boolean needIncreaseTraceNo)throws CallerException {
...
//        trace +1
        ...
        try {
            ...
            response = send(url,request, headers);
     ...
     * Send data
     */
    private String send(String url, String request, Map<String,String> headers) throws NetReceiveException, NetConnectException, NetHttpCodeException {
        //ssl certificate
...
//        }
        ...
        //send json data
        String response = httpOkHelper.httpPostJson(request, headers);
    ...
    public static class Builder {
         ...
         * @return a response object
         */
        public <T> T packComm(String url,Object request, Class<T> responseClass, boolean needIncreaseTraceNo) throws CallerException {
            JsonCaller caller = create();
            return caller.execute(url,request, responseClass, needIncreaseTraceNo);
        }
    }
} 