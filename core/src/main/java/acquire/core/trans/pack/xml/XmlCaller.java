...
public class XmlCaller extends BaseCaller {
     ...
     */
    public <T>T execute(String url,Object requestObject, Class<T> responseClass) throws CallerException {
        //trace +1
        ...
        try {
            ...
            LoggerUtils.e("response XML convert to bean failed!",e);
     ...
     * Send data
     */
    private String send(String url, String request) throws NetReceiveException, NetConnectException, NetHttpCodeException {
        //ssl certificate
...
//        }
    ...
    public static class Builder {
         ...
         * @return response data object
         */
        public <T> T packComm(String url,Object request, Class<T> responseClass) throws CallerException {
            XmlCaller caller = create();
            return caller.execute(url,request, responseClass);
        }
