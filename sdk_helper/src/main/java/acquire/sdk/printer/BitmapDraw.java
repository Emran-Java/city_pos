...
public class BitmapDraw {
    ...
    private void setFont(Paint paint){
        //please put your ttf file into res/font
//        Typeface typeface= ResourcesCompat.getFont(BaseApplication.getAppContext(), R.font.your_font_name);
//        paint.setTypeface(typeface);
    ...
    public void textBracCardReportInnerTran(String leftText, String centerText, String rightText, float textSize, boolean bold) {
        int[] percents = {36, 31, 34};
        String[] texts = {leftText, centerText, rightText};
        Paint.Align[] aligns = {Paint.Align.CENTER, Paint.Align.CENTER, Paint.Align.CENTER};
        float[] textSizes = {textSize, textSize, textSize};
        boolean[] bolds = {bold, bold, bold};
        textMulti(percents, texts, aligns, textSizes, bolds);
    }
